...
public class Foodmenu {
    ...
    public void edit(String Nname, double Nprice){
        ...
        Foodmenu.this.price = Nprice;
            System.out.println("Changed item : " + Nname + " to : " + Nname + " php.");
    }
   
    public static void main(String[] args) {
        
        Scanner scan = new Scanner(System.in);
        Foodmenu menu1 = new Foodmenu(null,0.0);
        Foodmenu menu2 = new Foodmenu(null,0.0);
        Foodmenu menu3 = new Foodmenu(null,0.0);
        Foodmenu menu4 = new Foodmenu(null,0.0);
        Foodmenu menu5 = new Foodmenu(null,0.0);
        Foodmenu menu6 = new Foodmenu(null,0.0);
        Foodmenu menu7 = new Foodmenu(null,0.0);
        Foodmenu menu8 = new Foodmenu(null,0.0);
        Foodmenu menu9 = new Foodmenu(null,0.0);
        Foodmenu menu10 = new Foodmenu(null,0.0);
